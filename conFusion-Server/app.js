...
// app.use(cookieParser('12345-67890-09876-54321'));//Unique value

app.use(session({       //Using session instead of cookieParser
  name: 'session-id',
  secret: '12345-67890-09876-54321',//same as used in cookieParser
